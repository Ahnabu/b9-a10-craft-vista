        ...
        <div className="h-full">
            ...
            <div className="flex items-center -mx-4 overflow-x-auto overflow-y-hidden sm:justify-center flex-nowrap dark:bg-gray-100 dark:text-gray-800 mt-6 ">
                ...
                <p onClick={() => { setTab(2), setLink('Scrapbooking') }}
                    className={`flex items-center flex-shrink-0 px-5 py-3 space-x-2 ${tab === 2 ? 'border border-b-0' : 'border-b '} dark:border-gray-900 dark:text-gray-600 `} >
                ...
                <p onClick={() => { setTab(5), setLink('Lampworking') }}
                    className={`flex items-center flex-shrink-0 px-5 py-3 space-x-2 ${tab === 5 ? 'border border-b-0' : 'border-b '} dark:border-gray-900 dark:text-gray-600 `} >

                    <span className="font-semibold ">Lampworking</span>
                </p>
                <p  onClick={() => { setTab(6), setLink('Glass Dying & Staining') }}
                    className={`flex items-center flex-shrink-0 px-5 py-3 space-x-2 ${tab === 6 ? 'border border-b-0' : 'border-b '} dark:border-gray-900 dark:text-gray-600 `} >
